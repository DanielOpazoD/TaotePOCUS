...
| 0016 | [Phase 1 media loading fluidity (LQIP, combined prefetch, blob enforcement)](./0016-media-loading-fluidity-phase-1.md) | Accepted (post-merge documentation for gate compliance) |
