...
export const Icon = {
  ...
  // Gear / cog — used by the header's admin entry point in lieu of
  // the "Administrar" text label, so the admin affordance becomes a
  // recognised iconographic shortcut without crowding the nav rail.
  // 8-tooth silhouette + center hole — Tabler / Phosphor convention.
  gear: (): ReactElement => (
    <svg viewBox="0 0 24 24" {...stroke}>
