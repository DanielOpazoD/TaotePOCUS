...
export const DICT_EN: Dict = {
  ...
  "category.neurocritico": "Neurocritical",
  ...
  "tagExplorer.deleteConfirm.message": 'Hide "{tag}" across every case?',
  "tagExplorer.deleteConfirm.title": 'This affects every case that carries the "{tag}" tag',
  "tagExplorer.deleteConfirm.yes.label": "Yes",
  "tagExplorer.deleteConfirm.yes.aria": "Confirm hide tag",
  "tagExplorer.deleteConfirm.yes.title": "Confirm",
  "tagExplorer.deleteConfirm.no.label": "No",
  "tagExplorer.deleteConfirm.no.aria": "Cancel",
  "tagExplorer.deleteConfirm.no.title": "Cancel",
  ...
  "modal.nav.aria": "Case navigation",
  "modal.nav.prev.aria": "Previous case",
  "modal.nav.prev.title": "Previous (←)",
  "modal.nav.next.aria": "Next case",
  "modal.nav.next.title": "Next (→)",
  ...
  // pass). EN parity for `dict.es.ts:"cine.playAria"`.
  "cine.playAria": "Play video",
  ...
  "bulk.action.tags": "Tags…",
  "bulk.tags.currentAria": "Tags present in the selection — click to remove",
  "bulk.tags.removeTitle": 'Remove "{tag}" from {count} selected case(s)',
  "bulk.tags.addPlaceholder": "Add a tag…",
  "bulk.tags.addAria": "Add a tag to the selected cases",
  "bulk.tags.addSubmit": "Add to {count}",
