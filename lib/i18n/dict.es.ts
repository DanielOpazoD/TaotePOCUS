...
export const DICT_ES = {
  ...
  "tagExplorer.deleteConfirm.message": "Ocultar «{tag}» en todos los casos?",
  "tagExplorer.deleteConfirm.title":
    "Esta acción afecta todos los casos que tengan la etiqueta «{tag}»",
  "tagExplorer.deleteConfirm.yes.label": "Sí",
  "tagExplorer.deleteConfirm.yes.aria": "Confirmar ocultar etiqueta",
  "tagExplorer.deleteConfirm.yes.title": "Confirmar",
  "tagExplorer.deleteConfirm.no.label": "No",
  "tagExplorer.deleteConfirm.no.aria": "Cancelar",
  "tagExplorer.deleteConfirm.no.title": "Cancelar",
